...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function (e) {
      e.preventDefault();
      alert(
        "Talebiniz için teşekkürler! Kısa süre içinde ücretsiz bir fiyat teklifiyle sizinle iletişime geçeceğiz."
      );
      this.reset();
    });
  }
  ...
  if (newsletterForm) {
    newsletterForm.addEventListener("submit", function (e) {
      e.preventDefault();
      alert(
        "Bültenimize abone olduğunuz için teşekkürler! Temizlik ipuçları ve özel teklifler alacaksınız."
      );
      this.reset();
    });
  }
